...
class TestPriceEmailBody(TestCase):
    ...
    def test_header_row_contains_instrument_codes_in_order(self):
        prices = {
            'VTI.US': [('2024-01-15', 255.92)],
            'AAPL.US': [('2024-01-15', 170.77)],
            'TSLA.US': [('2024-01-15', 280.50)],
        }
    ...
    def test_multiple_dates_per_instrument_produce_separate_rows(self):
        prices = {'VTI.US': [('2024-01-15', 255.92), ('2024-01-14', 253.00)]}
        ...
        self.assertIn('253.0', lines[2])

    def test_different_dates_across_instruments_produce_separate_rows(self):
    ...
    def test_most_recent_date_returns_latest_date(self):
        prices = {
            'VTI.US': [('2024-01-15', 255.92), ('2024-01-14', 253.00)],
            'BTC-USD.CC': [('2024-01-14', 42000.0)],
        }
